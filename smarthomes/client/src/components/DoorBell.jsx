...
//Node if there is space in the name of the product, it will not be displayed in view review
const img = {
...
const DoorBell = (e) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("http://localhost:9000/api/getDoorBells");
